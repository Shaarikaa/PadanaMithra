...
export function SignupPage() {
  ...
  return (
    <div className="flex min-h-screen flex-col bg-white lg:flex-row">
      <div className="relative hidden flex-1 overflow-hidden bg-gradient-to-br from-violet-600 via-indigo-600 to-indigo-600 lg:flex lg:flex-col lg:justify-between lg:p-12">
      ...
      <div className="flex flex-1 items-center justify-center px-4 py-10 sm:px-6">
        <div className="w-full max-w-sm">
          ...
          <p className="mt-1.5 text-sm text-slate-500">It is free and takes less than a minute.</p>
          ...
          <p className="mt-6 text-center text-sm text-slate-500">
            ...
            <button onClick={() => navigate({ name: 'login' })} className="font-semibold text-indigo-600 transition hover:text-indigo-700">
              Log in
            </button>
          </p>
        </div>
